...
1. Go to **Settings** → **Devices & Services** → **Deye Cloud**
...
If "Deye Cloud" doesn't appear in the integration list:

1. Check that all files are in the correct location
2. Verify file permissions (files should be readable)
3. Check Home Assistant logs for errors:
   - **Settings** → **System** → **Logs**
   - Look for errors mentioning "deye_cloud"
...
logger:
  default: info
  logs:
    custom_components.deye_cloud: debug
```
...
2. Replace the files in `/config/custom_components/deye_cloud/`
...
4. Select **Delete**
5. Optionally, remove the `/config/custom_components/deye_cloud/` folder
